...
/* package LocalSearch-0.1.0.0 */
#ifndef VERSION_LocalSearch
#define VERSION_LocalSearch "0.1.0.0"
#endif /* VERSION_LocalSearch */
#ifndef MIN_VERSION_LocalSearch
#define MIN_VERSION_LocalSearch(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_LocalSearch */
...
#define CURRENT_COMPONENT_ID "LocalSearch-0.1.0.0-inplace-LocalSearch"
